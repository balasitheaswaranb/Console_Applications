package com.implementation.radis;
		...
		public static void main(String[] args) {
			...
			while (true) {
				try {
					...
					if ( function.equals("GET") || function.equals("UNSET")) {
						if (splitLength != 2) {
							MainMethod.syntax();
							continue;
						}

					} else if (function.equals("SET") ||function.equals("UPDATE") || function.equals("COUNT") || function.equals("STRLEN")) {
						if (splitLength != 3) {
							MainMethod.syntax();
							continue;
						}
